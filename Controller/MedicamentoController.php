...
if (isset($_POST["btnAgregarMedicamento"])) {
    $res = AgregarMedicamentoModel($_POST["Nombre"], $_POST["Principio"], $_POST["Presentacion"], $_POST["Precio"]);
    header("Location: ../View/Medicamentos/Medicamento.php");
}

if (isset($_POST["btnActualizarMedicamento"])) {
    $res = ActualizarMedicamentoModel($_POST["IDMedicamento"], $_POST["Nombre"], $_POST["Principio"], $_POST["Presentacion"], $_POST["Precio"]);
    header("Location: ../View/Medicamentos/Medicamento.php");
}
