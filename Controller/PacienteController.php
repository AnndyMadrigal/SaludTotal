...
function ConsultarPacientePorID($id)
{
    return ConsultarPacientePorIDModel($id);
}
function ConsultarDirecciones()
{
    return ConsultarDireccionesModel();
}
...
if (isset($_POST["btnAgregarPaciente"])) {
    ...
    if (empty($_POST["cboDistrito"])) {
        ...
        header("Location: ../View/Pacientes/Pacientes.php?error=DatosIncompletos");
        exit;
    }
