<?php
    ...
    function ConsultarPersonal() { return ConsultarPersonalModel(); }
    function ConsultarPersonalPorID($id) { return ConsultarPersonalPorIDModel($id); }
    function ConsultarRolesPersonal() { return ConsultarRolesPersonalModel(); }
    function ConsultarSucursalesLista() { return ConsultarSucursalesListarModel(); }
