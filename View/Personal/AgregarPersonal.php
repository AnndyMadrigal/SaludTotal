...
<div class="content-wrapper"> <div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-4 mt-4"> <h4 class="card-header">Agregar Personal</h4> <div class="card-body">
        <form action="../../Controller/PersonalController.php" method="POST">
            <div class="row">
                <div class="col-md-4 mb-3"><label>Nombre</label><input type="text" class="form-control" name="Nombre" required></div>
                <div class="col-md-4 mb-3"><label>Apellido Paterno</label><input type="text" class="form-control" name="ApellidoP" required></div>
                <div class="col-md-4 mb-3"><label>Apellido Materno</label><input type="text" class="form-control" name="ApellidoM" required></div>
            </div>
            <div class="mb-3"><label>Fecha Contratación</label><input type="date" class="form-control" name="FechaContrato" required></div>
            ...
            <button class="btn btn-primary" name="btnAgregarPersonal" type="submit">Guardar</button>
